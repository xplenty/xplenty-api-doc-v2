...
`package.json` file is generated by [export API endpoint](https://github.com/xplenty/xplenty-api-doc-v2/blob/master/section/get-package-export-as-json.md). The existing package's metada will be overrided by this parameter.
```shell
