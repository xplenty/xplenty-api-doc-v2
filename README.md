...
```shell
$ curl -I "https://api.xplenty.com/:account_id/api/clusters?page=3&limit=10"
```
...
```
Link: <https://api.xplenty.com/:account_id/api/clusters?page=4&limit=10>; rel="next", 
      <https://api.xplenty.com/:account_id/api/clusters?page=2&limit=10>; rel="prev"
```

`rel="next"` says that the next page is `page=4` and `rel="prev"` says that the previous page is `page=2`. Using this information, you could traverse through the list of results in the API call.
...
* [Bing Ads Accounts informations](https://github.com/xplenty/xplenty-api-doc-v2/blob/master/sections/get-bingads-accounts.md)
* [Bing Ads Columns informations](https://github.com/xplenty/xplenty-api-doc-v2/blob/master/sections/get-bingads-columns.md)
* [Salesforce objects informations](https://github.com/xplenty/xplenty-api-doc-v2/blob/master/sections/get-salesforce-objects.md)
* [Salesforce fields informations](https://github.com/xplenty/xplenty-api-doc-v2/blob/master/sections/get-salesforce-fields.md)
